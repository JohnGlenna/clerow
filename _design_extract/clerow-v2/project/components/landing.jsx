/* Clean landing — hero + 3 storyboard rows + pricing + FAQ + final CTA + footer */

function Landing({ showMascot, onSignup, onSignin, onScanRequest }) {
  return (
    <>
      <LandingNav showMascot={showMascot} onSignup={onSignup} onSignin={onSignin} onScanRequest={onScanRequest} />
      <LandingHero showMascot={showMascot} onScanRequest={onScanRequest} />
      <LandingExample />
      <LandingHow />
      <LandingPricing onSignup={onSignup} />
      <LandingFAQ />
      <LandingFinalCTA showMascot={showMascot} onScanRequest={onScanRequest} />
      <LandingFooter showMascot={showMascot} />
    </>
  );
}

/* -------- Nav -------- */
function LandingNav({ showMascot, onSignup, onSignin, onScanRequest }) {
  return (
    <header className="nav">
      <div className="shell nav-inner">
        <a className="brand" href="#/">
          <span className="brand-mark">
            {showMascot ? <MascotClerow size={36} /> :
              <svg width="32" height="32" viewBox="0 0 32 32"><rect x="2" y="2" width="28" height="28" rx="8" fill="var(--ink)"/><text x="16" y="22" textAnchor="middle" fill="#fff" fontFamily="Nunito" fontWeight="900" fontSize="16">C</text></svg>
            }
          </span>
          <span>Clerow</span>
        </a>
        ...
        <div className="nav-actions">
          <button className="btn btn--quiet btn--sm" onClick={onSignin}>Sign in</button>
          <button className="btn btn--primary btn--sm" onClick={() => onScanRequest("")}>
...
/* -------- Hero (centered, mascot floats) -------- */
function LandingHero({ showMascot, onScanRequest }) {
  return (
      ...
      <div className="shell">
        ...
        <div className="hero-c-headline">
          <h1 className="h1 hero-c-h1">
            When AI gets asked about your market,{" "}
            <em>does it name you?</em>
          </h1>
        </div>
        ...
        <div className="hero-c-form-wrap">
          ...
          <ScanForm onScanRequest={onScanRequest} centered ctaLabel="Scan free" />
        </div>
      </div>
    </section>
  );
...
/* Inline URL → scan form, used in hero & final CTA */
function ScanForm({ onScanRequest, centered, ctaLabel }) {
  ...
  return (
    <form className={`scan-form ${centered ? "scan-form--centered" : ""}`} onSubmit={submit}>
...
/* -------- Live example: a real prompt + its AI search result -------- */
function LandingExample() {
  const rows = [
    { rank: 1, name: "Suno",        color: "#FF7A45", initial: "S", vis: 30, sent: "pos",  pos: 1.8 },
  ...
  return (
    <section className="example section">
      <div className="shell">
        ...
        {/* Step 1: discovered prompts for example domain */}
        <DiscoveryStrip />

        <div className="example-wrap">
          {/* Chat bubble showing the prompt asked to a chatbot */}
          <div className="example-prompt">
            ...
            <div className="example-bubble user">
              ...
              <span className="bubble-text">"What is the best AI music generator?"</span>
            </div>
          ...
          {/* Analytics table — Peec-style */}
          <div className="example-card">
            <div className="example-card-head">
              <div>
                <div className="example-card-title">AI search results — 7 models</div>
                <div className="example-card-sub">Sample data for "What is the best AI music generator?"</div>
              </div>
                ...
                <div key={r.rank} className={`ex-row ${r.me ? "ex-row--me" : ""}`}>
                  ...
                  <span className="ex-vis">
                    <span className="ex-vis-bar">
                      <i style={{ width: `${(r.vis / 30) * 100}%`, background: r.me ? "var(--accent)" : "var(--ink)" }} />
                    </span>
                    <b>{r.vis}%</b>
                  </span>
            ...
            <div className="example-card-foot">
              <span>📍 You're not being cited. <b>Clerow shows you exactly why — and what to fix first.</b></span>
            </div>
          </div>
        </div>
      </div>
...
/* Step 1 visual — the prompts Clerow auto-discovers for an example domain */
  ...
  return (
    <div className="discovery">
      <div className="discovery-head">
        <div>
          <div className="dsc-eyebrow">Step 1 · discovered for <span className="mono">warbls.com</span></div>
      ...
      <div className="discovery-chips">
        {discovered.map((d, i) => (
          <span key={i} className="dsc-chip">
            <span className="dsc-tag" style={{ background: `color-mix(in oklab, ${tagCol(d.tag)} 14%, white)`, color: tagCol(d.tag), borderColor: `color-mix(in oklab, ${tagCol(d.tag)} 30%, transparent)` }}>
              {d.tag}
            </span>
            <span className="dsc-q">"{d.q}"</span>
      ...
      <div className="discovery-foot">
        ...
        <span><b>Step 2:</b> we run each prompt through all 4 AI models, then score how you rank.</span>
      </div>
    </div>
  );
}

/* -------- What Clerow does (3 simple steps + how we get you cited) -------- */
function LandingHow() {
  const steps = [
    {
      tag: "01 · Scan",
    ...
    <section id="how" className="section section--soft">
      <div className="shell">
        ...
        <div className="how-actions-head">
          ...
          <p className="lede">Four concrete things Clerow ships into your week — not vague "optimisation".</p>
        </div>
    ...
    <section id="pricing" className="section section--soft">
      <div className="shell">
        <div className="section-head">
          ...
          <h2 className="h2">One price. No sales call.<br /><span className="muted">Cancel anytime, with one click.</span></h2>
        </div>
            ...
            return (
              <div key={t.key} className="price-card">
                ...
                <div className="price-amount">
                  <span className="num"><span className="currency">$</span>{price}</span>
                </div>
...
/* -------- Final CTA -------- */
function LandingFinalCTA({ showMascot, onScanRequest }) {
  return (
    <section className="final-cta">
      <div className="shell">
        ...
        <h2 className="h2">
          Ready to stop being <span style={{ color: "var(--accent-2)" }}>invisible</span>?
        </h2>
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          <ScanForm onScanRequest={onScanRequest} centered />
        </div>
      </div>
    </section>
  );
...
/* -------- Footer -------- */
function LandingFooter({ showMascot }) {
  return (
        ...
        <div className="footer-grid">
          <div className="footer-col">
            <div className="brand" style={{ marginBottom: 14 }}>
              {showMascot ? <MascotClerow size={32} /> : <span style={{ width: 32 }} />}
              <span>Clerow</span>
            </div>
