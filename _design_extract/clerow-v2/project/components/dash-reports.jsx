/* Reports — weekly summary + share + tier-gated white-label */

function PageReports({ onNavigate }) {
  return (
    <>
      <PageHead
        title="Reports"
        ...
        actions={
          <>
            ...
            <button className="btn btn--primary btn--sm"><Icon name="external" size={14} />Share link</button>
          </>
        }
      />
    ...
    <div className="report-card">
      <div className="report-header">
        ...
        <div className="report-score-tile">
          ...
          <span className="num">68 <small style={{ color: "var(--success)" }}>+8</small></span>
        </div>
      </div>
      ...
      <div className="report-grid">
          ...
          <div className="report-positions">
            {positions.map((p, i) => (
              <div key={i} className="rp-row">
                ...
                <span className={`rp-change ${p.good === true ? "good" : p.good === false ? "bad" : ""}`}>{p.change}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="report-block">
          ...
          <ul className="report-list">
            <li><span className="bullet bullet--success" /> FAQ schema added to homepage <b>+50 XP</b></li>
            <li><span className="bullet bullet--success" /> /compare/jira draft published <b>+200 XP</b></li>
            <li><span className="bullet bullet--success" /> 3 Reddit replies in r/projectmanagement <b>+90 XP</b></li>
            <li><span className="bullet bullet--success" /> Product schema on /features <b>+80 XP</b></li>
            <li><span className="bullet bullet--success" /> G2 listing claimed <b>+50 XP</b></li>
          </ul>
        </div>

        <div className="report-block report-block--win">
          <h4>🏆 Biggest win</h4>
          <p><b>You overtook Asana in ChatGPT.</b> Two weeks ago you were 4th. The /compare/jira page + 5 Reddit answers did it. Asana hasn't shipped anything new in this prompt cluster for 6 weeks.</p>
        </div>

        <div className="report-block report-block--opp">
          <h4>🎯 Biggest opportunity</h4>
          <p><b>Get listed on G2 + Capterra.</b> Your top rival Jira pulls 22 citations from these directories. You pull 0. Estimated <b style={{ color: "var(--accent-2)" }}>+18 visibility points</b> within 4 weeks of listing.</p>
        </div>
      </div>
  ...
  return (
    <div className="share-wrap">
      <div className="share-card">
        <div className="share-card-top">
          <div className="brand" style={{ fontSize: 18 }}>
            <MascotOwl pose="wave" size={28} /> Clerow Wrapped
          </div>
          <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--ink-3)", fontWeight: 700 }}>WEEK 11 · MAR 2026</span>
        </div>
      ...
      <div className="share-actions">
        ...
        <p>Solo founders posting their Clerow Wrapped on X get an avg <b>2.4k impressions</b>. Free distribution. We even draft the post.</p>
        <div className="share-buttons">
          <button className="btn btn--dark btn--sm">𝕏 Post to X</button>
          <button className="btn btn--ghost btn--sm">Copy image</button>
          <button className="btn btn--ghost btn--sm"><Icon name="external" size={12} />Copy link</button>
        </div>
      </div>
    </div>
  );
      ...
      <div className="data-table">
        ...
        {past.map((p, i) => (
          <div key={i} className="dt-row">
            ...
            <span style={{ flex: 2, fontSize: 13, color: "var(--ink-2)", fontWeight: 500 }}>{p.notes}</span>
  ...
  return (
    <div className="whitelabel-card">
      <div className="wl-left">
        ...
        <p>Drop your agency logo and brand colors. Auto-generated weekly. Send to 10 clients in one click. Per-seat contribution breakdowns included.</p>
        <ul>
      ...
      <div className="wl-right">
        <div className="wl-mock">
          <div className="wl-mock-header">
            <span style={{ width: 28, height: 28, borderRadius: 6, background: "#7C3AED", display: "inline-flex", alignItems: "center", justifyContent: "center", color: "#fff", fontWeight: 900, fontSize: 14 }}>AC</span>
