  ...
  return (
    <div className="share-pop-back" onClick={onClose}>
      <div className="upg-sheet" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="upg-sheet-sub">You&apos;ve cleared the free quick wins. Go Premium to unlock every level, re-scans across all 5 models, the leaderboard &amp; weekly reports.</p>
